...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_InteropPrices
    {
        ...
        public void ApplicationEngineFixedPrices()
        {
            ...
            using (ApplicationEngine ae = new ApplicationEngine(blockchain, TriggerType.Application, null,
                null, 0))
            {
                ae.LoadScript(SyscallSystemRuntimeCheckWitnessHash);
                InteropService.GetPrice(InteropService.Runtime.CheckWitness, ae.CurrentContext.EvaluationStack)
                    .Should().Be(0_00030000L);
            }
                ...
                null, 0))
            {
                ...
                InteropService.GetPrice(InteropService.Storage.GetContext, ae.CurrentContext.EvaluationStack)
                    .Should().Be(0_00000400L);
            }
                ...
                null, 0))
            {
                ...
                InteropService.GetPrice(InteropService.Storage.Get, ae.CurrentContext.EvaluationStack)
                    .Should().Be(0_01000000L);
            }
        }
        ...
        public void ApplicationEngineVariablePrices()
        {
            ...
            byte[] SyscallContractCreateHash00 = new byte[] { (byte)OpCode.PUSHDATA1, 0x01, 0x00,
                (byte)OpCode.PUSHDATA1, 0x02, 0x00, 0x00, (byte)OpCode.SYSCALL, 0xf6, 0x6c, 0xa5, 0x6e };
            using (ApplicationEngine ae = new ApplicationEngine(blockchain, TriggerType.Application, null,
                null, 0, testMode: true))
            {
                Debugger debugger = new Debugger(ae);
                ae.LoadScript(SyscallContractCreateHash00);
                debugger.StepInto(); // PUSHDATA1
                debugger.StepInto(); // PUSHDATA1
                InteropService.GetPrice(InteropService.Contract.Create, ae.CurrentContext.EvaluationStack)
                    .Should().Be(0_00300000L);
            }

            // System.Storage.Put: e63f1884 (requires push key and value)
            byte[] SyscallStoragePutHash = new byte[] { (byte)OpCode.PUSH3, (byte)OpCode.PUSH3, (byte)OpCode.PUSH0,
                ...
                null, 0, testMode: true))
            {
                ...
                InteropService.GetPrice(InteropService.Storage.Put, ae.CurrentContext.EvaluationStack)
                    .Should().Be(200000L);
            }

            // System.Storage.PutEx: 73e19b3a (requires push key and value)
            byte[] SyscallStoragePutExHash = new byte[] { (byte)OpCode.PUSH3, (byte)OpCode.PUSH3, (byte)OpCode.PUSH0,
                ...
                null, 0, testMode: true))
            {
                ...
                debugger.StepInto(); // push 03 (length 1)
                debugger.StepInto(); // push 00
                InteropService.GetPrice(InteropService.Storage.PutEx, ae.CurrentContext.EvaluationStack)
                    .Should().Be(200000L);
            }
        }
    }
